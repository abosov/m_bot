...
- [ ] Бронирование/изменение доступны только на следующий календарный день и только до 21:00 предыдущего дня по времени specialist (next day + cutoff 21:00); после 21:00 слоты на завтра недоступны
