...
- склейка стык-в-стык интервалов выполняется только на уровне domain-валидации доступности слота (например, 13:00–17:00 + 17:00–21:00 => 13:00–21:00); в UI интервалы отображаются строго в исходном виде, заданном специалистом
