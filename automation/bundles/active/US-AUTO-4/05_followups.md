...
```md
# US-AUTO-4 FOLLOW-UP PROMPT 1 — <Fix/Adjustment>

## ROLE
You are the System Architect + Developer + QA + Security Reviewer for Zumbot.

## CONTEXT
- Base story bundle: `automation/bundles/active/US-AUTO-4/`
- Previous run output: `automation/output/<story-run-id>/`
- Review checklist: `automation/bundles/active/US-AUTO-4/04_review_checklist.md`
...
## Story Context
- Story bundle: `automation/bundles/active/US-AUTO-4/`
- Objective: <objective>
