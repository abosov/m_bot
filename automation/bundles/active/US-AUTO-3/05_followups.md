...
```md
# US-AUTO-3 FOLLOW-UP PROMPT 1 — <Fix/Adjustment>

## ROLE
You are the System Architect + Developer + QA + Security Reviewer for Zumbot.

## CONTEXT
- Base story bundle: `automation/bundles/active/US-AUTO-3/`
- Previous run output: `automation/output/<story-run-id>/`
- Review checklist: `automation/bundles/active/US-AUTO-3/04_review_checklist.md`
...
## Story Context
- Story bundle: `automation/bundles/active/US-AUTO-3/`
- Objective: <objective>
