...
| US-AUTO-78 | Post-US-AUTO-60 registry roadmap and orchestration-line alignment | Realign the registry and operator guide after US-AUTO-60 closed the implementation-freeze and no-Codex review-evidence refresh blocker | governance | Planned | P1 | Draft bundle | Follow-up from US-AUTO-60 registry closeout and post-freeze pipeline planning | automation/bundle_packs/US-AUTO-78.bundle.md | Docs/governance-only story. Must update registry roadmap, remove stale US-AUTO-60 blocker references, add the orchestration line, and document the current story pipeline in the operator guide. No runtime scripts or tests should change. |
