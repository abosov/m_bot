...
- A new manual-finish final-HEAD proof gap was confirmed while attempting US-AUTO-70: companion-filtered review artifacts from the pinned rerun do not yet prove final-HEAD compliance for a valid manual-finish continuation, causing `blocked_manual_finish_final_head_unproven` / `review_changed_files_mismatch`.
...
- P1 rerun cost and cycle control after US-AUTO-56:
  ...
  - US-AUTO-71 — manual-finish final-HEAD compliance for companion-filtered review artifacts
...
1. US-AUTO-71 — manual-finish final-HEAD compliance for companion-filtered review artifacts
...
| US-AUTO-69 | Companion-artifact execution filtering for code-only stories | Isolate the execution-surface filtering half of the blocked US-AUTO-57 follow-up without expanding into rerun-preflight recomputation | split | Split | P1 | Park this split line until US-AUTO-70 and US-AUTO-71 both land and prove that rerun-preflight plus manual-finish final-HEAD compliance are no longer coupled to execution filtering | US-AUTO-57 | N/A | Split from the attempted continuation: execution filtering belongs to `automation/run_codex_task.sh` + `tests/test_run_codex_task.py`; return condition: resume only after US-AUTO-70 lands for rerun-preflight recomputation and US-AUTO-71 closes the companion-filtered manual-finish final-HEAD proof gap |
| US-AUTO-70 | Rerun-preflight stable-review recomputation for companion-filtered stories | Recompute the effective filtered review surface before rerun/gate so companion-filtered stories do not fail acceptance because rerun-preflight still evaluates the unadjusted surface | follow-up | Blocked | P1 | Park implementation; draft and land US-AUTO-71 before resuming this line | US-AUTO-69 split follow-up | automation/bundle_packs/US-AUTO-70.bundle.md | Implementation line reached committed rerun-preflight changes and green tests, but review continuation blocked on pinned run `2026-04-01_22-39-02` with `blocked_manual_finish_final_head_unproven` / `review_changed_files_mismatch`; do not widen US-AUTO-70 into review-stage scripts |
| US-AUTO-71 | Manual-finish final-HEAD compliance for companion-filtered review artifacts | Prove final-HEAD compliance for a valid manual-finish continuation when the pinned rerun artifacts were companion-filtered, without treating the filtered `changed_files.txt` surface as a mismatch against allowed story bundle / registry commits on final HEAD | follow-up | Planned | P1 | Draft bundle | US-AUTO-70 follow-up | N/A | New follow-up confirmed by pinned run `2026-04-01_22-39-02`; likely scope is in review/manual-finish proof logic rather than `run_story.sh`; keep atomic and do not reopen US-AUTO-70 rerun-preflight logic |
