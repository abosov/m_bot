...
- US-AUTO-75 is implemented and merged; the active stabilization continuation now moves to US-AUTO-76, US-AUTO-77, and then US-AUTO-74 before broader business-feature work.
...
- The immediate post-US-AUTO-75 stabilization block is: US-AUTO-76 for classifier scope semantics, US-AUTO-77 for operator workflow simplification, and US-AUTO-74 for behavior-preserving centralization cleanup. US-AUTO-31 and US-AUTO-58 remain next after that block unless new evidence changes priority.
