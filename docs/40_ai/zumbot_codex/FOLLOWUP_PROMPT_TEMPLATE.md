...
[IF THIS FIX REVEALS ANOTHER INDEPENDENT ISSUE, RECORD IT AS A SEPARATE FOLLOW-UP TASK AND DO NOT IMPLEMENT IT IN THIS RUN]

EXECUTION_GATE
[IF THIS FOLLOW-UP DOES NOT TARGET EXACTLY ONE FINDING/BLOCKER OR IS MISSING OR LEAVES AMBIGUOUS THE TARGET FINDING, INTENT, OUT_OF_SCOPE, ALLOWED/FORBIDDEN FILE BOUNDARIES, FOLLOW_UP_CAPTURE_RULE, OR HARD-STOP CONDITIONS, CODEX MUST STOP AND REFUSE IMPLEMENTATION UNTIL THE FOLLOW-UP PROMPT IS SPLIT OR CORRECTED]
