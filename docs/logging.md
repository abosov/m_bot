...
### P0 (MUST): маскирование webhook URL в access-логах nginx
...
Это требование уровня **P0/MUST** для production деплоя: релиз считается
невалидным, если `webhook_secret` может попасть в nginx access log.
