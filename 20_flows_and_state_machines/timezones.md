...
При изменении:
- принимается IANA timezone name (например `Europe/Berlin`)
- в интерфейсе доступны быстрые кнопки популярных зон и ручной ввод
- при ошибке валидации timezone клиент остаётся в режиме выбора
