...
6. Рабочую timezone.
7. Правило записи: бронирование и изменение доступны только на следующий день и только до 21:00 предыдущего дня по времени специалиста.
8. При расчёте доступности стыкующиеся интервалы (например, 13:00–17:00 и 17:00–21:00) склеиваются в единый диапазон.
