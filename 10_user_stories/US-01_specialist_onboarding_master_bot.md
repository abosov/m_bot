...
## Статус сценария
- **Implemented (MVP):** старт онбординга, ввод публичного имени, подключение personal bot, Google OAuth callback, создание календаря, выбор существующего календаря с пагинацией, интеграция календаря, финализация с переходом в personal bot.
...
2. Подключить Google.
3. Создать календарь и дождаться успешной интеграции.
